    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <a href="{{ route('posts.create') }}" class="mb-4 inline-block bg-blue-600 hover:bg-blue-800 text-white font-semibold py-2 px-4 rounded">
                    + d Post
                </a>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2">
                                ...
                                <form action="{{ route('posts.destroy', $post->id) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button onclick="return confirm('Delete this post?')" class="text-red-500 hover:underline">Delete</button>
                                </form>
                            </td>
                        </tr>
                        @empty
